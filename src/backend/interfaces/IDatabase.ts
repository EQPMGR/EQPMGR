...
export interface BatchWrite {
  ...
  setInSubcollection<T>(parentCollection: string, subCollection: string, docId: string, data: T): void;
  updateInSubcollection<T>(parentCollection: string, subCollection: string, docId: string, data: Partial<T>): void;
  deleteInSubcollection(parentCollection: string, subCollection: string, docId: string): void;
  commit(): Promise<void>;
}
