...
export default function ComponentDetailPage() {
  ...
  const fetchComponentData = useCallback(async (uid: string, equipmentId: string, userComponentId: string) => {
    ...
    try {
      ...
      const equipmentDocSnap = await database.getSubDoc<Equipment>('app_users', uid, 'equipment', equipmentId);
      ...
      const mainComponentDocSnap = await database.getSubDoc<UserComponent>(
        'equipment',
        equipmentId,
        'components',
        userComponentId
      ...
      const subComponentsSnap = await database.getDocs<UserComponent>(
        'components',
