...
export default function ProfilePage() {
  ...
  React.useEffect(() => {
    ...
    // Preserve any unsaved form edits while the user is interacting with inputs.
    // This avoids wiping typed fields when a preference radio button triggers
    // an async save that updates the user object.
