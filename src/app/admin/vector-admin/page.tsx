...
export default function VectorAdminPage() {
  ...
  const handleIndexComponents = async () => {
    ...
    try {
      ...
      let successCount = 0;
      let permissionErrorEncountered = false;
      ...
      if (permissionErrorEncountered) {
          toast({
              variant: 'destructive',
              title: "Permission Errors Encountered",
              description: "Some components failed to save due to Firestore permissions. Please check your Firestore Security Rules to ensure authenticated users can write to the 'masterComponents' collection.",
              duration: 9000,
          })
      }
