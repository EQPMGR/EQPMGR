...
export const bikeDatabase: BikeFromDB[] = [
  {
    ...
    components: [
      ...
      { name: 'Saddle', brand: 'S-Works', model: 'Power with Mirror', system: 'Cockpit' },
  ...
  },
  {
    ...
    components: [
      ...
      { name: 'Dropper Post', brand: 'Bike Yoke', model: 'Revive Max', system: 'Cockpit' },
    ],
  ...
  },
  {
    ...
    components: [
        ...
        { name: 'Dropper Post', brand: 'TranzX', model: 'JD-YSP39', system: 'Cockpit' },
    ],
  ...
  },
  {
    ...
    components: [
      ...
      { name: 'Seatpost', brand: 'Cervélo', model: 'S5 Carbon', system: 'Cockpit' },
    ],
  ...
  },
  {
    ...
    components: [
        ...
        { name: 'Seat Post', brand: 'Norco', model: 'Alloy 27.2mm', system: 'Cockpit' },
        { name: 'Saddle', brand: 'Norco', model: 'Cross Race', system: 'Cockpit' },
        { name: 'Headset', brand: 'FSA', model: 'No.42B/Cup Tapered', system: 'Cockpit' },
