...
export const bikeDatabase: BikeFromDB[] = [
  {
    ...
    components: [
      ...
      { name: 'Stem', brand: 'Specialized', model: 'Tarmac Integrated Stem', system: 'Frameset' },
    ],
  ...
  },
  {
    ...
    components: [
        ...
        { name: 'Stem', brand: 'Norco', model: 'N/A', system: 'Frameset' },
        { name: 'Handlebar', brand: 'Norco', model: 'Compact', system: 'Frameset' },
        { name: 'Grips', brand: 'Norco', model: 'Anti-Slip Tape', system: 'Frameset' },
