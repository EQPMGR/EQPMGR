...
const ExtractedComponentSchema = z.object({
  ...
  size: z.string().optional().describe('The default or single size of the component (e.g., "27.2mm"). Use sizeVariants for frame-size-dependent sizes.'),
  sizeVariants: z.any().optional().describe('An object mapping frame sizes to component sizes (e.g., {"S": "170mm", "M": "172.5mm"}).'),
